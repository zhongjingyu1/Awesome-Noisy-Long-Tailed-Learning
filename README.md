...
|[Federated Chain Context Optimization for Long-Tailed Multi-Label Image Classification](https://arxiv.org/pdf/2408.08125)|TMC|2025|-|-|
|[Exploring Prompt Distributions and Probability Bias for Long-Tailed Multi-Label Image Recognition](https://www.sciencedirect.com/science/article/abs/pii/S0950705126001061)|KBS|2026|-|-|
|  ----  | ----  |----  |---- |----|
|  ----  | ----  |----  |---- |----|
